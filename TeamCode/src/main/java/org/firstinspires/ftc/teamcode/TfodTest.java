...
@TeleOp(name="TFOD-Test", group="Linear Opmode")///This name will be on the drivers phone

public class TfodTest extends LinearOpMode {/// SkystoneTeleop8132Price(your Team Number and Your Last Name)
